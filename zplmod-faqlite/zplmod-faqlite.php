...
* Description: Responsive FAQ - Add using shortcode, compatible with responsive themes and reduce database calls. FAQ custom design options.
* Version: 1.0.20170712
...
#tab-content {background:#e9e9e9; border-top:3px solid #dd2727; border-radius:0px;} #tab-content > div {display:none; padding:15px;} #tab1:checked ~ #tab-content #tabcontent1, #tab2:checked ~ #tab-content #tabcontent2 {display:block;}
...
<div id="tab-main">
<input id="tab1" type="radio" name="tabs" checked ><label for="tab1"><span class="dashicons dashicons-media-code" style="vertical-align:top;"></span> General</label>
<input id="tab2" type="radio" name="tabs" ><label for="tab2"><span class="dashicons dashicons-nametag" style="vertical-align:top;"></span> About</label>
<div id="tab-content"> 
...
<p>Shortcode above FAQLite style change as one color or style to tab. If want to change specific tab or tabs below code.</p>
</span><hr><br>
...
[faqlite_tab no="02" title="Title 2 Or Header 2" tabspancolor="#333" tabbgcolor="#e21725" titlecolor="#fff" textbgcolor="#efcb28" textcolor="#555"]
Content Text Here 2
[/faqlite_tab]

</textarea><br><br><hr><br>
<p><b>FAQ.Lite Usage :</b></p><br/>
<img src="<?php echo plugins_url( 'faqlite.jpg', __FILE__ );?>" width="100%" >
</span><hr><br>
</li>
